--[[--------------------------------------------------------------------
	...
	Localization: Espanol (Espana)   (esES)
...
ACP:RegisterLocale("esES", {
	...
	["%s is collapsed. Setting all of its AddOns to %s."] = "%s está plegado. Todos sus AddOns pasan a %s.",
	["ENABLED"] = "ACTIVADOS",
	...
	["Click to toggle protected mode. Protected AddOns are re-enabled automatically when you reload the UI."] = "Haz clic para alternar el modo protegido. Los AddOns protegidos se vuelven a activar automáticamente al recargar la interfaz.",
	...
	["Blizzard_ItemSocketingUI"] = "Blizzard: Engarce de objetos",
	...
	["Blizzard_TokenUI"] = "Blizzard: Divisas",
