--[[--------------------------------------------------------------------
	...
	Localization: English (United Kingdom)   (enGB)
...
ACP:RegisterLocale("enGB", {
	...
	["Use SHIFT to override the current dependency enabling behavior."] = "Use SHIFT to override the current dependency enabling behaviour.",
